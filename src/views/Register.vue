<template>
  <div class="login_container">
    <div style="text-align: center; color: #67c23a; font-size: 30px">
      用户注册
    </div>
    <div class="login_box">
      <el-form
      ...
      >
        ...
        <el-form-item prop="code">
          <el-row :gutter="100">
            ...
            <el-col :span="10">
              <div v-show="show">
                <el-button
                  @click="validateEmail('loginFormRef')"
                  :disabled="disable"
                  type="primary"
                  >发送验证码</el-button
                >
        ...
        <el-form-item class="btns">
          <el-button type="primary" @click="register('loginFormRef')"
            >注册</el-button
          >
  ...
  methods: {
    ...
    register(formName) {
      this.$refs[formName].validate(async (valid) => {
        if (valid) {
          const _this = this;
          console.log("实际参数",this.loginForm)
    ...
    getCode() {
      this.disable = true;
      this.$http
        .post("/sendEmail", { email: this.loginForm.email })
        .then((res) => {

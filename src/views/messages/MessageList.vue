<template>
    <el-timeline style="margin-top: 20px">
        <el-timeline-item :key="index"  v-for="(item,index) in list" :timestamp="item.time" placement="top">
            <el-card>
                ...
                <div class="btns">
                    ...
                    <el-button type="danger"  @click="deletes(item.id)" icon="el-icon-delete"></el-button>
                </div>
            </el-card>
        </el-timeline-item>

    ...
    <div>
        ...
        <div class="edit-profile">
            ...
            <p>用户名:
                ...
                <router-link style="margin-left: 50%" :to="'/profile/'+user.username"><el-link type="success">返回个人主页</el-link></router-link>
            </p>
            <el-divider/>
            ...
            <el-dialog title="修改密码" :visible.sync="diaPassword">
                <el-form :rules="rules" ref="passwordForm" :model="passwordFrom">
                    <el-form-item label="旧密码" prop="lastPassword" >
                        <el-input type="password" show-password  v-model.trim="passwordFrom.lastPassword" autocomplete="off"></el-input>
                    </el-form-item>
                    <el-form-item label="新密码"  prop="newPassword">
                        <el-input type="password" show-password v-model.trim="passwordFrom.newPassword" autocomplete="off"></el-input>
                    </el-form-item>
                    <el-form-item label="确认密码" prop="sencondPassword" >
                        <el-input type="password" show-password v-model.trim="passwordFrom.sencondPassword" autocomplete="off"></el-input>
                    </el-form-item>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            subEditPassword(formName){
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        this.$http.post("/updatePassword",this.passwordFrom).then(res=>{
        ...
        computed:{
            ...
            info(){
                if(this.user.private_info){
                    return this.user.private_info
                }
                return '暂无'
            },
            email(){

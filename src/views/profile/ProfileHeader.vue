<template>
  <div class="profile">
    <div v-if="IsMe">
      ...
      <el-row>
        ...
        <el-col class="update" :span="4">
            <el-link type="success" @click="editProfile">
                <i class="el-icon-edit">编辑个人资料</i>
            </el-link>
        </el-col>
      </el-row>
    ...
    <div v-else>
      ...
      <el-button style="margin-left: 30%" @click="open" type="danger"
        >举报</el-button
      >
      <el-row>
        <el-col class="info" :span="5">简介:{{ user.private_info }}</el-col>
...
export default {
  ...
  computed: {
    sex() {
      if (this.user.sex === 0) return "未知";
      else if (this.user.sex === 1) return "男";
      return "女";
    },
  },
  methods: {
